...
import { CompareBlockMobile } from './CompareBlockMobile'; // ✅ ДОБАВЛЕНО: Импорт мобильной версии
import { ContactFormModal } from './ContactFormModal'; // ✅ ДОБАВЛЕНО: Импорт модального окна контактов
import { debounce } from '@/lib/performance-utils';
import { noiseTexture } from '@/assets'; // ✅ ИСПРАВЛЕНО: Импорт из @/assets
